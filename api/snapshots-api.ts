...
// @ts-ignore
import { SnapshotList } from '../model';
/**
...
export const SnapshotsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        clustersSnapshotsGet: async (clusterId: string, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/clusters/{clusterId}/snapshots`
...
/**
 * Request parameters for clustersSnapshotsGet operation in SnapshotsApi.
 * @export
 * @interface SnapshotsApiClustersSnapshotsGetRequest
 */
export interface SnapshotsApiClustersSnapshotsGetRequest {
    /**
...
export class SnapshotsApi extends BaseAPI {
     ...
     * Retrieves MongoDB snapshots.
     * @summary Get the snapshots of your cluster
     * @param {SnapshotsApiClustersSnapshotsGetRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
